...
> ## ✅ SUPERSEDED BY IMPLEMENTATION — historical planning artifact
>
> This task-by-task plan (including its embedded `git commit` command blocks) was
> **fully executed**; the `TraceSource` primitive, the `Draw` vertex-only-exit
> lifecycle, and the example refactor all shipped on this branch. It is retained
> only as a historical record of how the work was sequenced — **do not follow its
> steps or run its embedded commands.**
>
> For the as-built design and current behaviour, see
> **[docs/topological-curve-drawing-report.md](../../topological-curve-drawing-report.md)**
> and the design spec
> **[docs/superpowers/specs/2026-06-16-trace-source-primitive-design.md](../specs/2026-06-16-trace-source-primitive-design.md)**.
