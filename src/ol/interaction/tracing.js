...
function canSwitchTraceTarget_(oldTarget, newTarget, coordinate) {
  return (
    isTraceVertexPivot_(oldTarget, newTarget, coordinate) ||
    isStoredSharedTraceVertex_(oldTarget, newTarget)
  );
}
 ...
 */
function isTraceVertexPivot_(oldTarget, newTarget, coordinate) {
  return (
    getTraceVertexIndexAtCoordinate_(oldTarget, coordinate) !== null &&
 ...
 */
function isStoredSharedTraceVertex_(oldTarget, newTarget) {
  if (
 ...
 */
function getTraceVertexIndexAtCoordinate_(target, coordinate) {
  const coordinates = target.coordinates;
